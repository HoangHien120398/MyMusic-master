...
// Đầu tiên tạo một class FavoriteSong, tạo một bảng gồm ID_FAVORITE, ID_PROVIDER, FAVORITE, VÀ COUNT
...
// Sử dụng SQLite để luu tru nhưng bai hat yeu thich
...
// onUpgrade được gọi khi database được nâng cấp
        @Override
    ...
    //Hàm onCreate() để viết những câu lệnh tạo bảng
    @Override
